...
public class TweetClient extends JFrame {
	...
	public void initializeGUI(){
		...
		final JLabel messageLabel=new JLabel("<html> Messages");
					...
					subscriber.addObserver(new Observer(){
						...
						public void update(String message) {
							...
							if (messageLabel!=null){
								String previousText=messageLabel.getText();
								messageLabel.setText(previousText+"<br>"+message);
							}
		...
		secondPagePanel.add(messageLabel);
